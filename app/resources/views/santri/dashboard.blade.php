            ...
            <div class="grid grid-rows-6 gap-6 lg:grid-cols-3">
                ...
                @foreach ($jadwal as $item)
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
                        <h5 class="mb-4 text-base font-medium tracking-tight text-gray-900 text-start">{{ $item->formatted_waktu }}
                        </h5>
                        <div class="mb-4">
                            <!-- Modal toggle -->
                            <button data-modal-target="absen-modal" data-modal-toggle="absen-modal"
                                ...
                                data-kelas="{{ $item->kelas }}" data-waktu="{{ $item->formattedwaktu }}"
                                data-kegiatan="{{ $item->kegiatan->nama }}" data-santri="{{ $santri->id }}">
                                <h4 class="text-base font-medium text-slate-700 mt-2 mb-4">{{ $item->kegiatan->nama }}</h4>
                                ...
                                <h4 class="text-sm font-normal text-slate-700 mb-2">Pendamping : Bang {{ $item->musrif->nama }}
                                </h4>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 class="text-lg font-semibold text-gray-900">
                                <input type="text" class="border-white" name="kegiatan" id="" disabled>
                            </h3>
                            <button type="button"
