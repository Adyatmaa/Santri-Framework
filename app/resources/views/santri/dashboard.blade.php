    ...
    <section class="my-6">
        <div class="grid grid-rows-6 gap-6 lg:grid-cols-3">
            ...
            <div
                ...
                <h5 class="mb-4 text-base font-medium tracking-tight text-gray-900 text-start">Senin</h5>
                <div class="mb-4">
                    <!-- Modal toggle -->
                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                        ...
                        <p class="text-xs font-light text-slate-700 mb-3">18.00</p>
            ...
            <div
                ...
                <h5 class="mb-4 text-base font-medium tracking-tight text-gray-900">Senin</h5>
                <div class="mb-4">
                    <!-- Modal toggle -->
                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                        class="block text-white bg-emerald-200 hover:bg-emerald-300 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full text-left"
